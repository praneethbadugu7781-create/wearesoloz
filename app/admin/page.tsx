...
import { Compass, MapPin, BookOpen, Image as ImageIcon, MessageSquareQuote, MailQuestion, AlertCircle, Loader2, Briefcase, HeartHandshake, Video } from "lucide-react";
  ...
  useEffect(() => {
    async function loadDashboard() {
      try {
        ...
        const [trips, dests, blogs, gallery, testimonials, contacts, careers, farmers, reels] = await Promise.all([
          ...
          fetch(`${API_URL}/admin/reels`, { headers }).then(r => r.ok ? r.json() : []),
        ]);
        ...
        setStats([
          ...
          { label: "Reels", value: reels.length, icon: Video, color: "text-pink-400 bg-pink-500/15 border-pink-500/20" },
