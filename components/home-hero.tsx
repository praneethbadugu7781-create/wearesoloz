      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 text-center text-white flex flex-col items-center space-y-6">
        ...
        >
          ...
          <div className="pt-6">
            <a
              href="/upcoming-trips"
              className="inline-flex items-center justify-center bg-white text-stone-950 px-10 py-4 rounded-full font-bold text-xs sm:text-sm uppercase tracking-widest hover:bg-stone-100 hover:scale-[1.03] active:scale-[0.98] transition-all duration-300 shadow-[0_4px_20px_rgba(0,0,0,0.15)]"
            >
              Discover Now
            </a>
          </div>
