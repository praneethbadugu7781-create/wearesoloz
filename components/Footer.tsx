...
export default function Footer() {
  ...
  return (
    <footer data-testid="footer" className="relative rounded-t-[3rem] md:rounded-t-[5rem] border-t border-white/10 bg-[#0c0a09] text-stone-300 overflow-hidden font-body mt-20">
      {/* Background ambient lighting */}
      <div className="absolute top-0 left-1/4 w-[600px] h-[500px] bg-gradient-to-br from-[#ea580c]/5 to-transparent rounded-full blur-[140px] pointer-events-none" />
      <div className="absolute bottom-0 right-1/4 w-[500px] h-[400px] bg-gradient-to-tr from-[#12352d]/10 to-transparent rounded-full blur-[120px] pointer-events-none" />
      ...
      <div className="relative max-w-7xl mx-auto px-6 md:px-10 pt-24 pb-12 z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          ...
          {/* Card 1: Brand & Stats */}
          <div className="lg:col-span-2 rounded-3xl border border-white/[0.06] bg-white/[0.01] p-8 flex flex-col justify-between space-y-8 hover:border-white/10 transition-colors duration-300">
          ...
          <div className="lg:col-span-2 rounded-3xl border border-white/[0.06] bg-gradient-to-br from-[#12352d]/10 via-white/[0.01] to-[#ea580c]/5 p-8 flex flex-col justify-between space-y-6 relative overflow-hidden group hover:border-[#ea580c]/20 transition-all duration-300">
            <div className="absolute top-0 right-0 w-40 h-40 bg-[#ea580c]/5 rounded-full blur-2xl pointer-events-none group-hover:bg-[#ea580c]/10 transition-colors" />
            <div className="absolute bottom-0 left-0 w-32 h-32 bg-[#12352d]/10 rounded-full blur-xl pointer-events-none" />
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="relative z-10 w-full py-3.5 px-5 rounded-xl bg-gradient-to-r from-[#ea580c] to-[#ff7a1a] text-white hover:from-[#ff7a1a] hover:to-[#ea580c] font-bold text-xs flex items-center justify-center gap-1.5 transition-all shadow-[0_4px_20px_rgba(234,88,12,0.2)] hover:shadow-[0_4px_25px_rgba(234,88,12,0.4)]"
            >
          ...
          <div className="rounded-3xl border border-white/[0.06] bg-white/[0.01] p-6 space-y-6 hover:border-white/10 transition-colors duration-300">
            ...
            <ul className="space-y-3.5 text-sm text-stone-400">
              ...
              <li>
                <Link href="/travel-stories" className="group flex items-center gap-2 hover:text-[#ff7a1a] transition-all duration-300 hover:translate-x-1">
                  <ArrowRight className="w-3.5 h-3.5 text-[#ea580c] opacity-0 -ml-4 group-hover:opacity-100 group-hover:ml-0 transition-all duration-300 shrink-0" />
                  Travel Stories
                </Link>
              </li>
          ...
          <div className="rounded-3xl border border-white/[0.06] bg-white/[0.01] p-6 space-y-6 hover:border-white/10 transition-colors duration-300">
            ...
            <ul className="space-y-3.5 text-sm text-stone-400 font-medium">
              <li>
          ...
          <div className="lg:col-span-2 rounded-3xl border border-white/[0.06] bg-white/[0.01] p-6 flex flex-col sm:flex-row items-center gap-6 group hover:border-[#ea580c]/20 transition-all duration-300">
            <img
            ...
            <div className="space-y-2 text-center sm:text-left">
              <p className="text-stone-300 leading-relaxed text-sm font-display italic">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
                ...
                <Link href="/about-akhil" className="text-[10px] uppercase tracking-wider font-bold text-white hover:text-[#ff7a1a] inline-flex items-center justify-center gap-1 transition-colors font-sans">
        ...
        <div className="absolute bottom-16 left-0 right-0 text-center select-none pointer-events-none z-0 overflow-hidden leading-none">
          <span 
            className="text-[12vw] font-black uppercase tracking-[0.15em] text-transparent opacity-[0.02] block"
        ...
        <div className="relative border-t border-white/5 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-stone-500 font-medium z-10">
          ...
          <div className="flex items-center gap-6">
            <div className="flex items-center gap-3">
              <a href="https://youtube.com/@akhillrockstartravelstories?si=_c7w-zLBaUwBgMSi" target="_blank" rel="noreferrer" className="hover:text-white transition-colors duration-300 text-stone-500">
                <Youtube className="w-4 h-4" />
              </a>
              <a href="https://www.instagram.com/wearesolozindia?igsh=MWZjNjN0MXhidWJ2Yw==" target="_blank" rel="noreferrer" className="hover:text-white transition-colors duration-300 text-stone-500">
                <Instagram className="w-4 h-4" />
              </a>
              <a href="https://wa.me/919966085310" target="_blank" rel="noreferrer" className="hover:text-white transition-colors duration-300 text-stone-500">
            ...
            <button 
              type="button"
              onClick={scrollToTop} 
              className="text-stone-500 hover:text-white transition-colors duration-300 flex items-center gap-1.5"
            >
              Back to Top
            </button>
          </div>
